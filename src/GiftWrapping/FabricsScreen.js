...
export default class FabricsScreen extends React.Component {
    ...
    async getFabrics() {
        this.setState({ isLoading: true },
            async () => this.setState({ brands: await Store.getFabrics(this.state.language) },
    ...
    render() {
        ...
        return (
            <>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingVertical: 10, borderColor: '#0451A5', borderWidth: 1, borderTopWidth: 0, flex: (this.state.brands && this.state.brands.length > 0) ? 0 : 1 }}>
                    ...
                    <ProductModal isRTL={strings.isRTL}
                        measurement={main.state.measurement}
